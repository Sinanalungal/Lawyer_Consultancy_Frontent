...
const ForgotPasswordForm: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setLoading(false); // Hide loader when form submission ends
        }
    };

    return (
        <>
            {loading && <Loader width='w-full' height='min-h-screen'/>} {/* Show the loader conditionally */}
           {(!loading)&&( <section className="bg-gray-200 dark:bg-gray-900">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div className="w-full p-6 bg-white shadow-md rounded-lg dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
                        ...
                        <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="w-full bg-gray-950 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                Reset password
                            </button>
                        </form>
                    </div>

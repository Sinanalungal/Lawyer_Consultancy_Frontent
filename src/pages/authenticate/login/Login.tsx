...
const Login = () => {
  ...
  const { isAuthenticated,user,role ,loader } = useSelector((state: any) => state.login);
              ...
              <div className="relative z-10  bbg-gray-900 w-full max-w-md">
                  ...
                  <div className=" mt-16 space-y-3">
                      ...
                      <div className="flex items-center -space-x-2 overflow-hidden">
                        {lawyers.map((lawyer_data)=>(<img key={lawyer_data.id} src={`${ImgBackendUrl}${lawyer_data.profile}`} className="w-10 h-10 rounded-full border-2 border-white" />))}
              ...
              <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                  <div className="">
                      ...
                      <div className="mt-5 space-y-2">
                          ...
                          <p className="text-sm">Don't have an account? <Link to="/register" className="font-medium text-indigo-600 hover:text-indigo-500">Register</Link></p>
                      </div>
                  </div>
                  <div 
                  // className="grid grid-cols-3 mx-auto w-full gap-x-3"
                  className="grid  mx-auto  gap-x-3">
                    <GoogleLoginButton/>
                      {/* <button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                          <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <defs>
                                  <clipPath id="clip0_17_40"><button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                          <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">

    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axiosInstance.post(
          BASE_URL + "blogsession/saved-blogs/",
          { user_id: value }
        );
      ...
      {!loader && (
        <>
          ...
          {blogs.length > 0 ? (
            ...
            <div className="h-screen w-full mx-auto p-4  sm:text-sm font-semibold sm:w-[80%]  rounded-lg  flex justify-center items-center">
              no saved blogs
            </div>
          )}
        </>

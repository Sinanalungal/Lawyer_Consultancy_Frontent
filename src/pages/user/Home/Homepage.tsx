...
const Homepage: React.FC = () => {
    ...
    return (
        <div className="homepage">
            ...
            <div className=" homepage_elements max-sm:hidden dark:bg-black items-center relative max-lg:h-[420px] h-[600px]" style={{ backgroundImage: `url("./image-banner.png")`, backgroundSize: "contain", backgroundRepeat: 'no-repeat', backgroundPositionX: 'right', width: "100%" }}>
            ...
            {/* <div className="homepage_elements sm:hidden dark:bg-black items-center relative" style={{ width: "100%" }}>
                <div className="h-[80%] w-[100%] flex flex-col justify-center py-6">
                    ...
                    <div className="w-full dark:bg-black relative" style={{ backgroundImage: `url("image-banner2.png")`, backgroundSize: "cover", backgroundRepeat: 'no-repeat', backgroundPositionX: 'right', width: "100%", height: "600px" }}>

...
const SocialMediaCard: React.FC = ({ userDetails, setUserDetails }) => {
  ...
  return (
    <>
      <div className="w-full p-4 md:px-12 max-md:items-center  md:py-4 lg:py-16 flex max-md:flex-col sm:w-[80%] items-start bg-gray-100 rounded-3xl">
        ...
        <div className="flex-grow w-full  sm:w-[80%] p-4 ">
          <div className="flex space-y-4 max-md:justify-center justify-between space-x-1 flex-wrap w-full max-sm:mx-auto items-end mb-2">
          ...
          <div className="w-full py-5 flex max-md:justify-center space-x-7 max-[400px]:text-xs sm:ml-4">
